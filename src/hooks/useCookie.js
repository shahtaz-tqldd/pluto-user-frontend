...
export const setAuthCookie = (auth, name = "pluto", path = "/") => {
...
export const getAuthCookie = (name = "pluto") => {
...
export const removeAuthCookie = (name = "pluto", path = "/") => {
...
export const isAuthenticated = (name = "pluto") => {
